package com.yzpocket.esg_showcase_app.auth.config;

import com.yzpocket.esg_showcase_app.auth.filter.JwtAuthenticationFilter;
import com.yzpocket.esg_showcase_app.auth.handler.OAuth2LoginSuccessHandler;
import com.yzpocket.esg_showcase_app.auth.service.CustomOAuth2UserService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/generations", "/api/generations/**").permitAll()
